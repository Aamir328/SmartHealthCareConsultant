            ...
            <div class="popular-course-content">
                ...
                <span></span>
					...
					<table>
						...
						<form align="center" action="add_doctor_db.php" method="post">
						<br>
						...
						<tr><td><br><br></td></tr>
						<tr><td>Aadhar no:</td>
							<td><input type="number" name="dadhar_no"></td>
						</tr>
						<tr><td><br><br></td></tr>
						<tr><td>License no:</td>
						...
						<tr><td><br><br></td></tr>	
						<tr><td>Address:</td>
							<td><textarea type="text" name="daddr"></textarea></td>
						</tr>
						<tr><td><br><br></td></tr>	
						<tr><td>Pincode:</td>
						...
						<tr><td>Phone number:</td>
							<td><input type="number" name="dphno"></td>
						</tr>

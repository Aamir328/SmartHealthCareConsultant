            ...
            <div class="popular-course-content">
                ...
                <span></span>
					...
					<table width="20">
						...
						<form align="center" action="add_disease_db.php" method="post">
						<br>
						<tr><td colspan="2"></td></tr>
						<tr><td><br><br></td></tr>
						
							
						<tr><td>Disease name:</td>
							<td><input type="text" name="dis_nm" cols="50" rows="10"></td>
						</tr>
						<tr><td><br><br></td></tr>	
						...
						<tr><td>Department:</td>
							<td><select name="dept" cols="50" rows="10">
							...
							while($arr=mysqli_fetch_array($result))
							{
								...
								$disp=$did.' '.$dnm;
							?>
							<option value=<?php echo $did ?>><?php echo $disp; ?></option>
							<?php
						...
						<tr><td><br><br></td></tr>	
						<tr><td>Symptoms:</td>
							<td><textarea type="text" name="symptoms" cols="30" rows="10"></textarea></td>
						</tr>
						...
						<tr><td colspan="2" align="center"><input  class="btn academy-btn btn-sm mt-15" type="submit" value="save"></td></tr>
							</form></table>		
            </div>

...
<body>
    ...
    <section class="about-us-area mt-50 section-padding-100">
	   ...
	   <div align="left" >	<a href="add_doctor.php"><img src="img/core-img/add.png" alt="addlogo" height="50" width="50"> Add Doctors</font></img></a></div>
					...
					$disp="
					  <table text='white' bgcolor='#f2f3f4' width=100% border=1>
							<tr>
								...
								<th style='text-align:center'>PinNo</th>
							...
							<tr>
								...
								<td align='center'>$dadhar</td>
								<td align='center'>$dlicense</td>
								
								<td align='center'>$dfname</td>
								<td align='center'>$dlname</td>
								<td align='center'>$ddept</td>
								<td align='center'>$daddr</td>
								<td align='center'>$pin</td>
								<td align='center'>$dphno</td>
								
								<td align='center'>$demail</td>
								<td align='center'><a href='delete_doctor.php?did=$dadhar'><img src='img/core-img/del1.jpg' height='20' width='20'></a></td>
							</tr>";
							}
							$disp.="	
						</table>";

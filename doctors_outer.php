                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="department_outer.php">Department</a></li>
                                    <li><a href="doctors_outer.php">Doctors</a></li>
					...
					$disp="
					  <table text='white' bgcolor='#f2f3f4' width=100% border=1>
							...
							<tr>
								...
								<td>$demail</td>
								<td align='center'><a href='loggin.php'><img src='img/core-img/appoint.png'  height='35' width='35'></a></td>
							</tr>";
							}
							$disp.="	
							</table>";

...
<body>
    ...
    <section class="about-us-area mt-50 section-padding-100">
	   ...
	   <div align="left" >	<a href="add_disease.php"><img src="img/core-img/add.png" alt="addlogo" height="50" width="50"> Add Diseases</font></img></a></div>
					...
					$disp="
					  <table text='white' bgcolor='#f2f3f4' width=100% border=1>
							...
							<tr>
								...
								<td align='center'>$disease_nm</td>
								<td>$symptoms</td>
								<td align='center'>$dept_id</td>
								
								
								<td align='center'><a href='modify_disease.php?did=$disease_id'><img src='img/core-img/edit.png' height='20' width='20'></a></td>
							</tr>";
							}
							$disp.="	
						</table>";

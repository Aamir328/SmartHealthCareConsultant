                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <div class="login-content">
                                <a href="loggin.php">Register / Login</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="tel:+654563325568889"><i class="icon-telephone-2"></i> <span>(+91) 8790437532</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        <span>The</span>
                        <h3>Smart HealthCare Consultant</h3>
                    </div>
                </div>
            </div>
            <div class="row">
               
                <p>This system aims at getting online appointments from various doctors for related treatments.The system user must register as a member of this system and find nearby doctors and can generate an appointment request with their related issues and suitable date and time for their meetings with the doctor.Patients can then select from a list of doctors based on different medical departments such as (skin specialist,ENT specialist,cardiologist etc).The doctors may accept or refuse the appointment requests  and may also allot timings to the appointments based on their availability .This system also provides an interactive feature between patient and doctor through query box, where patients can post their queries that are visible to all the doctors to which any doctor can post their replies. Other registered patients can also view all list of queries and their solution along with the doctor name and respective department who replied to the query.
				</p>

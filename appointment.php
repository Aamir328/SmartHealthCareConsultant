<?php
	...
	$sql1="select * from patient where adhar_no='$pat_id'";
	$result1=mysqli_query($con,$sql1);
	$arr1=mysqli_fetch_array($result1);
	$pfnm=$arr1['fname'];
	$pmnm=$arr1['mname'];
	$plnm=$arr1['lname'];
	$pat_nm=$pfnm.' '.$pmnm.' '.$plnm;
	
	$_SESSION['doc_id']=$doc_id;
	$sql2="select * from doctor where adhar_no='$doc_id'";
	$result2=mysqli_query($con,$sql2);
	$arr2=mysqli_fetch_array($result2);
	$dfname=$arr2['fname'];
	$dlname=$arr2['lname'];
	$doc_nm=$dfname.' '.$dlname;
	?>
    ...
    <div class="popular-course-details-area wow fadeInUp" data-wow-delay="300ms">
        <div class="single-top-popular-course d-flex align-items-center flex-wrap">
            <div class="popular-course-content">
					<table>
						<form method="post" action="appointment_db.php">
						<tr><th>Make an appointment!</th></tr>
						<tr><td><br></td></tr>
						
						<tr><td align="right">Doctor's name:</td>
						  <td><input type="text" name="doc_nm" id="" value=<?php echo $doc_nm?> disabled ></td>
						<tr><td><br></td></tr>
						<tr><td align="right">Patient's name:</td>
						  <td><input type="text" name="pat_nm" id="" value=<?php echo $pat_nm?> disabled></td>
						<tr><td><br></td></tr>
						<tr><td align="right">Date of appointment:</td>
						  <td><input type="date" name="request_dt" id="" placeholder="Date of appointmnet" ></td>
						<tr><td><br></td></tr>
						<tr><td align="right">Patient's Issues:</td>
						  <td><textarea type="text" name="issues" id="" placeholder="Issues of the patients" ></textarea></td>
						<tr><td><br></td></tr>
						
						  
						
						<tr><td colspan="2" align="center"><input class="btn academy-btn btn-sm mt-15" type="submit" value="REQUEST"></td>
						<br><br><br>
